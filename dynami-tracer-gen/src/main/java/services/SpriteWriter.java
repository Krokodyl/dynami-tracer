...
public class SpriteWriter {
    ...
    public void writeSmallLatinCharacterSprites(String name, byte[] data) {
        ImageReader imageReader = new ImageReader();
        List<BufferedImage> images = new ArrayList<>();
        int offset = Constants.OFFSET_SMALL_LATIN;
        for (int i=1;i<=Constants.COUNT_SMALL_LATIN;i++) {
            String file = "src/main/resources/images/"+name+i+".png";
            try {
